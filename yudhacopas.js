...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('HAFIZZ GANZZ', {
		font: 'Standard',
	...
	dha.on('connecting', () => {
		console.log(color('[ Hafizz Gans ]', 'yellow'), color('PROSES NYAMBUNG...'));
	})
const spinner = { 
  "interval": 120,
  "frames": [
	...
	//connect
	dha.on('open', () => {
		console.log(color('[ Hafizz Gans ]', 'yellow'), color('BOT SUDAH AKTIF  SELAMAT MENGGUNAKAN'));
	})
