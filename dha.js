...
petik = '```'
fake = '© F i z z - S t y l e e'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 ","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© `,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 ", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
      ...
      mentions(cptl, x, true)
       ...
       case 'donasi':
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '!youtube',buttonText:{displayText: 'WIBU'},type:1},{buttonId:'!infoig',buttonText:{displayText:'INSTAGRAM'},type:1}]

               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: 'DONT SPAM KAWAN',
               buttons: buttons,
               headerType: 1
}
...
*Sewa bot?* Chat wa.me/6285892842367`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'ALL MENU'},type:1},{buttonId: `${prefix}rules`,buttonText:{displayText: 'RULES BOT'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 F i z z', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
               ...
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 `, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
*Chat Owner :* wa.me/6289626156638`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
*ID Guild :* 1026943860 (Alip)
*Minat Join? Chat* wa.me/6281245393206
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
_*Tunggu Proses Upload Media......*_`
      ...
      case 'ttnowm': 
      case 'tiktoknowm':
      if (!isPremium) return reply(`User Gratisan Banyak Gaya`)
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Kontol', imageMessage: imageMsg,
...
sendFileFromUrl(res[0].link, audio, {mimetype :  'audio/mp4' , duration : 359996400, ptt : true, quoted : mek , filename: res[0].output})
}
if (teks.endsWith("-doc")){
...
sendFileFromUrl(res[0].link, document, {mimetype :  'audio/mp4' , duration : 359996400, ptt : true, quoted : mek , filename: res[0].output})
}
break
case 'play2':   
...
*[Wait] Tunggu Sebentar..*`
              ...
              if (!q) return reply('Linknya?')
              buttons = [{buttonId:`${prefix}playy ${q}`,buttonText:{displayText:'🎵 Mp3'},type:1}]
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI \`\`\`')
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©ADMIN* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:` ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/fizz_xyzz`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/BABvK9FXJaoLg9')
             break
      case 'ownermenu':
