      ...
      mentions(cptl, x, true)
       ...
       case 'donasi':
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '',buttonText:{displayText: 'WIBU'},type:1}]
...
*Cek list Server GTIVD dibawah!*`
              ...
              dha.relayWAMessage(prep)
                break
        case 'command':
        lagnya = fs.readFileSync('./src/menu.mp3')
               list = []
               ...
               dha.sendMessage(from, lagnya, audio,{mimetype: 'audio/mp4', duration : 0 , ptt : true,  quoted: fgif})
               break
       case 'othercmd':
               list = []
               listmenu = [`ruleswave`]
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
              ...
              gopeynya = 'https://i.ibb.co/ByRb3sW/52f231771722.jpg'
              teksnya = `*[ PRICE LIST ]*
*Sewa Bot  ON 24 Jam*
*1 Hari :* 2K
*1 Minggu :* 10K
...
//------------------< Menunya Bang:v >-------------------
      ...
      case 'infoig':
             ...
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/BXJaoLg9')
             break
      case 'ownermenu':
